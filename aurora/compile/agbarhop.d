...
IF ~Global("AGBootToB","GLOBAL",1)~ agtobbar
  ...
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_8%)~ + @33 /* ~Take me to the Tankard Tree.~ */+ agtankard
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_8%)~ + @34 /* ~Take me to the Amkethran Inn.~ */+ agamketh
...
IF ~Global("AGBarGo","GLOBAL",1)~ agwhich
  ...
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~  + @11 /* ~Take me to the Mithrest Inn.~ */ + agmith
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @12 /* ~Take me to the Den of the Seven Vales.~ */ + agden
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @13 /* ~Take me to the Sea's Bounty.~ */ + agsea
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @14 /* ~Take me to the Copper Coronet.~ */ + agcopper
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @15 /* ~Take me to the Five Flagons.~ */ + agfive
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @17 /* ~Take me to Calbor's Inn.~ */ + agcalbor
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @16 /* ~Take me to the Crooked Crane.~ */ + agcrane
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @18 /* ~Take me to Imnesvale Inn in the Umar Hills.~ */ + agumar
  + ~GlobalGT("chapter","GLOBAL",%bg2_chapter_1%)~ + @19 /* ~Take me to Vyatri's Pub in Trademeet.~ */ + agtrade
