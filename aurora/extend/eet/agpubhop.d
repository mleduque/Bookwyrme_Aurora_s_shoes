...
IF ~Global("AGBarGo","GLOBAL",1)~ agwhich
  ...
  + ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @40 /* ~Take me to Ulgoth's Beard Inn.~ */ + agulgoth
  + ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @41 /* ~Take me to the Elfsong Tavern.~ */ + agelfsng
  + ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @42 /* ~Take me to the Helm and Cloak.~ */ + aghelm
  + ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @43 /* ~Take me to Ye Olde Inn.~ */ + agolde
